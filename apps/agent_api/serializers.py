...
class AgentHeartbeatSerializer(serializers.Serializer):
    ...
    version = serializers.CharField(required=False, default="", allow_blank=True, help_text="Agent 版本号")
    pve_version = serializers.CharField(required=False, default="", allow_blank=True, help_text="PVE 版本号")
