...
urlpatterns = [
    ...
    path("cluster-tasks/", views.ClusterTaskListView.as_view(), name="scanner-cluster-tasks"),
    path("cluster-log/", views.ClusterLogListView.as_view(), name="scanner-cluster-log"),
]
